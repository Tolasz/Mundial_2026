...
```
Realizujesz ticket T11 (Typ mistrza + bonus 50). Pracuj wg 00-orchestrator.md i PLAN.md.
...
2. Logika bonusu:
   - Gdy znany mistrz turnieju (finał rozliczony — drużyna-zwycięzca finału), gracze
     z champion_team_id == mistrz dostają +settings.championship_bonus_points (50) do sumy.
...
- Po finale gracze z trafionym mistrzem mają +50 pkt w rankingu; pozostali bez bonusu.
- Bonus liczony raz (idempotentnie).

Definition of Done: test+build+commit "T11: typ mistrza + bonus 50".
```
